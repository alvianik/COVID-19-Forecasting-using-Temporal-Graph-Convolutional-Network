...
from input_data import preprocess_data,load_it_data,load_fr_data
...
flags.DEFINE_string('dataset', 'it', 'it or fr.')
flags.DEFINE_string('model_name', 'tgcn', 'tgcn or gcn.')
...
###### load data ######
if data_name == 'it':
    data, adj = load_it_data('it')
if data_name == 'fr':
    data, adj = load_fr_data('fr')
